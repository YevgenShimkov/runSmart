...
gulp.task('html', function () {
    return gulp.src("src/*.html")
        ...
        .pipe(gulp.dest('dist/')) // куда поместится файл после min
});
...
gulp.task('scripts', function () {
    return gulp.src("src/js/**/*.js") // берем любые файлы в папке js  с расширением js
...
gulp.task('fonts', function () {
    return gulp.src("src/fonts/**/*")
        .pipe(gulp.dest('dist/fonts')) // куда поместится файл после min
});
/**
...
gulp.task('icons', function () {
    return gulp.src("src/icons/**/*")
        .pipe(gulp.dest('dist/icons')) // куда поместится файл после min
});
/**
...
gulp.task('mailer', function () {
    return gulp.src("src/mailer/**/*")
        .pipe(gulp.dest('dist/mailer')) // куда поместится файл после min
});
